...
Run:
  python scripts/distill_symbolic.py --ckpt weights_signal/run_.../signal_checkpoint_best.pt --backend pysr
...
def main():
    ap = argparse.ArgumentParser(description="C3 symbolic distillation (PySR + DAgger) of the SIGNAL policy.")
    ap.add_argument("--ckpt", default=None, help="SIGNAL checkpoint (the SR substrate). Omit -> self-test.")
