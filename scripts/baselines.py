...
def validate_canonical(lambdas=None, L=4, select_episodes=60, eval_episodes=120, env_cfg=None,
    ...
    After this, the defensible claim is: "SIGNAL recovers X% of the gap to the validated-optimal
...
def regime_benchmark(lambdas=None, select_episodes=80, eval_episodes=200, env_cfg=None,
    ...
    if verbose:
        ...
        print(f"\n  Headroom SIGNAL must capture (BAR-Oracle) = {means['BAR_static'] - means['Oracle']:.1f}")
        ...
        print(f"  SIGNAL targets: BEAT static BAR={means['BAR_static']:.0f} (the real bar) and "
